...
export const toolSEO: Record<string, { title: string; description: string; keywords: string }> = {
  ...
  "json-to-xml": { title: "JSON to XML Converter Online", description: "Convert JSON data to XML format instantly. Free online converter.", keywords: "json to xml, xml converter, json xml" },
  "json-to-rust": { title: "JSON to Rust Struct Generator", description: "Convert JSON to Rust struct definitions with serde derive. Free tool.", keywords: "json to rust, rust struct, serde json" },
  "json-to-kotlin": { title: "JSON to Kotlin Data Class Generator", description: "Convert JSON to Kotlin data class definitions. Free online tool.", keywords: "json to kotlin, kotlin data class, json kotlin" },
  "json-to-swift": { title: "JSON to Swift Struct Generator", description: "Convert JSON to Swift Codable struct definitions. Free tool.", keywords: "json to swift, swift codable, json swift struct" },
  "json-flattener": { title: "JSON Flattener & Unflattener Online", description: "Flatten nested JSON to dot notation or unflatten back. Free tool.", keywords: "json flatten, json unflatten, nested json, dot notation" },
  "text-statistics": { title: "Text Statistics & Readability Analyzer", description: "Analyze text readability score, word count, reading time and more. Free tool.", keywords: "text statistics, readability score, flesch kincaid, reading time" },
  "markdown-toc": { title: "Markdown TOC Generator Online", description: "Generate Table of Contents from Markdown headings automatically. Free tool.", keywords: "markdown toc, table of contents, markdown headings, toc generator" },
  "text-find-replace": { title: "Find & Replace Text Online", description: "Find and replace text with regex support and case sensitivity. Free tool.", keywords: "find replace, text replace, regex replace, search replace" },
  "lorem-json": { title: "Lorem JSON Generator — Random Test Data", description: "Generate random JSON data for testing and prototyping. Free tool.", keywords: "lorem json, random json, test data, mock json, json generator" },
  "text-wrapper": { title: "Text Wrapper — Wrap Text at Width", description: "Wrap text at a specific character width for formatting. Free tool.", keywords: "text wrapper, word wrap, line wrap, text format, wrap text" },
  "readme-generator": { title: "README Generator — Create README.md", description: "Generate README.md files for your projects interactively. Free tool.", keywords: "readme generator, readme template, readme md, project readme" },
  "eslint-config": { title: "ESLint Config Generator Online", description: "Generate .eslintrc.json configuration with TypeScript, React, Prettier support. Free tool.", keywords: "eslint config, eslint generator, eslintrc, eslint setup" },
  "tsconfig-gen": { title: "tsconfig.json Generator Online", description: "Generate TypeScript configuration interactively with target, module and lib options. Free tool.", keywords: "tsconfig generator, tsconfig json, typescript config, ts config" },
  "hmac-generator": { title: "HMAC Generator — SHA-256, SHA-384, SHA-512", description: "Generate HMAC signatures using SHA-256, SHA-384 or SHA-512. Free online tool.", keywords: "hmac generator, hmac sha256, hmac signature, message authentication" },
  "sri-hash": { title: "SRI Hash Generator — Subresource Integrity", description: "Generate Subresource Integrity hashes for CDN scripts and styles. Free tool.", keywords: "sri hash, subresource integrity, sri generator, cdn security" },
  "base32": { title: "Base32 Encoder & Decoder Online", description: "Encode and decode Base32 strings. Free online Base32 tool.", keywords: "base32 encoder, base32 decoder, base32 convert, encode base32" },
  "age-calculator": { title: "Age Calculator — Exact Age from DOB", description: "Calculate exact age from date of birth in years, months and days. Free tool.", keywords: "age calculator, calculate age, age from birthday, date of birth" },
  "bmi-calculator": { title: "BMI Calculator — Body Mass Index", description: "Calculate BMI from weight and height with health category. Free tool.", keywords: "bmi calculator, body mass index, bmi check, weight calculator" },
  "loan-calculator": { title: "Loan/EMI Calculator — Monthly Payment", description: "Calculate monthly EMI, total payment and interest for loans. Free tool.", keywords: "loan calculator, emi calculator, mortgage calculator, interest calculator" },
  "tip-calculator": { title: "Tip Calculator — Split Bills Easily", description: "Calculate tip amount and split between people. Free tool.", keywords: "tip calculator, split bill, tip percentage, restaurant tip" },
  "discount-calc": { title: "Discount Calculator — Price After Discount", description: "Calculate discounted price and savings amount. Free tool.", keywords: "discount calculator, price discount, sale calculator, savings calculator" },
  "scientific-calc": { title: "Scientific Calculator Online", description: "Calculator with sin, cos, tan, log, sqrt and more. Free tool.", keywords: "scientific calculator, math calculator, sin cos tan, calculator online" },
  "user-agent-parser": { title: "User Agent Parser — Browser Detection", description: "Parse and analyze browser user agent strings. Detect browser, OS, engine. Free tool.", keywords: "user agent parser, browser detection, ua parser, user agent analyzer" },
  "port-reference": { title: "Common Network Ports Reference", description: "Quick reference for well-known network ports and services. Free tool.", keywords: "network ports, common ports, port reference, port numbers, tcp udp ports" },
  "url-parser": { title: "URL Parser — Analyze URL Components", description: "Parse URLs into protocol, host, path, query params and more. Free tool.", keywords: "url parser, parse url, url components, url analyzer, query params" },
  "http-method-ref": { title: "HTTP Methods Reference Guide", description: "Quick reference for all HTTP request methods with properties. Free tool.", keywords: "http methods, http verbs, get post put delete, http reference" },
  "color-mixer": { title: "Color Mixer — Blend Colors Online", description: "Mix two colors together and generate color steps. Free tool.", keywords: "color mixer, blend colors, mix colors, color blender, color steps" },
  "font-pair": { title: "Font Pair Generator — Typography Pairings", description: "Discover beautiful font pairings with live preview and CSS export. Free tool.", keywords: "font pairing, font pair, google fonts, typography, font combination" },
  "css-filter-gen": { title: "CSS Filter Generator — Visual Editor", description: "Generate CSS filter effects with blur, brightness, contrast and more. Free tool.", keywords: "css filter generator, css filter, blur brightness contrast, filter editor" },
  "css-columns": { title: "CSS Columns Generator — Multi-Column Layout", description: "Generate CSS multi-column layouts visually with gap and rule controls. Free tool.", keywords: "css columns, multi column, column layout, css column generator" },
  "structured-data": { title: "JSON-LD Structured Data Generator", description: "Generate JSON-LD structured data markup for SEO. WebSite, Article, Product types. Free tool.", keywords: "json-ld generator, structured data, schema org, seo markup, rich snippets" },
  "license-gen": { title: "Open Source License Generator", description: "Generate MIT, Apache, GPL, BSD and ISC license files. Free tool.", keywords: "license generator, mit license, open source license, apache license, gpl" },
  "changelog-gen": { title: "Changelog Generator — Keep a Changelog", description: "Generate CHANGELOG.md entries following Keep a Changelog format. Free tool.", keywords: "changelog generator, changelog md, keep a changelog, release notes" },
  "editorconfig-gen": { title: "EditorConfig Generator Online", description: "Generate .editorconfig files for consistent coding styles. Free tool.", keywords: "editorconfig generator, editorconfig, code style, indent style" },
  "prettier-config": { title: "Prettier Config Generator Online", description: "Generate .prettierrc configuration interactively. Free tool.", keywords: "prettier config, prettierrc, prettier generator, code formatting" },
