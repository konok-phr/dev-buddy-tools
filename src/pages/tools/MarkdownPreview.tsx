    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 min-h-[300px]">
        <div>
          ...
          <Textarea value={md} onChange={e => setMd(e.target.value)} className="font-mono text-sm bg-card h-[300px] sm:h-[500px] resize-none" />
        </div>
        <div>
          <label className="text-xs text-muted-foreground mb-1 block">Preview</label>
          <div className="markdown-preview bg-card border border-border rounded-md p-4 h-[300px] sm:h-[500px] overflow-auto">
